...
export const profile: SiteProfile = {
  ...
  about:
    "Software engineer at Leonardo Helicopters in Milan, building production-grade systems across AI pipelines, backend services, and developer tooling. At Leonardo I built a vision-LLM document-comparison pipeline, stood up the division's first CI/CD pipeline, and shipped a local agentic RAG system for requirements retrieval, all alongside developing and verifying embedded avionics software under DO-178C. That safety-critical background gives me a strong bias toward rigor and correctness, which I carry into everything I build. Outside of work I am drawn to quantitative finance and enjoy applying engineering thinking to markets.",
...
export const skills: SkillGroup[] = [
  ...
  {
    category: 'Backend',
    items: ['FastAPI', 'PostgreSQL', 'SQLite', 'ChromaDB'],
  },
  {
...
export const experience: ExperienceEntry[] = [
  {
    ...
    tech: ['Python', 'C', 'GitLab CI', 'Vision LLM', 'Agentic RAG'],
  },
]
...
export const projects: Project[] = [
{
    ...
    tech: ['Python', 'Vision LLM','Prompt Engineering', 'LM Studio'],
...
export const background: BackgroundEntry[] = [
  ...
  {
    title: 'MSc Robotics & Automation Engineering, Erasmus',
